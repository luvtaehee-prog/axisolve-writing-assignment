(function () {
  ...
  function buildPrompt(grade, doc, keywordsText, feedback) {
    ...
    // 직접 입력 주제는 한글로 적힐 수 있고, 사용자가 넣은 아이디어를 반드시 살려야 한다.
    var customNote = doc.custom
      ? "\n\n[직접 입력 주제 처리 규칙]\n" +
        "- 이 주제는 사용자가 직접 입력한 것이다. 한국어로 적혀 있을 수 있다.\n" +
        "- 한국어라면 의미를 살려 영어 주제문으로 옮긴 뒤, 에세이는 반드시 영어로 작성할 것.\n" +
        "- 사용자가 적은 아이디어/소재를 에세이의 핵심 내용으로 반드시 반영할 것.\n" +
        "- 학년별 분량·구조 규칙은 기출 주제와 동일하게 적용할 것."
      : "";
